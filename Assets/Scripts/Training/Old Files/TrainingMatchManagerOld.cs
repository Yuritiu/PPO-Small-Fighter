...
public class TrainingMatchManagerOld : MonoBehaviour
{
    [Header("Fighters (NewFighter)")]
    public NewFighterOld fighterA;
    public NewFighterOld fighterB;
    ...
    [Header("Agents")]
    public FighterAgentOld agentA;
    public FighterAgentOld agentB;
    ...
    {
        if (agentA == null && fighterA != null) agentA = fighterA.GetComponent<FighterAgentOld>();
        if (agentB == null && fighterB != null) agentB = fighterB.GetComponent<FighterAgentOld>();
        ...
        if (FightManagerOld.instance != null)
        {
            ...
            FightManagerOld.instance.SyncHealthBars();
        }
    }
    ...
    void ResetFighter(NewFighterOld fighter, Transform spawn, bool startOnLeftSide)
    {
